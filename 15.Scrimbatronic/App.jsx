...
/* Challenge
	...
	Something important isn't yet working on this synth keyboard: the keys! Your task is to allow the user to play the keys with either their mouse button or computer keyboard as follows:  
		...
		Plan of Attack:
			...
			3. Update synthKeys state array. 
				- Update target object. 
					- mouseDown or keyDown -> target object's active property = true 
						- keyDown -> also -> target object's keyPressed property = true 
					- keyUp -> target object's keyPressed property = false 
*/
